        ...
        <div className="lg:col-span-2">
          <Card className="h-full">
            <CardContent className="p-0">
              ...
              <div className="p-6">
                {/* Mock chart with simple bars - would be replaced with a real chart library */}
                    ...
                    <div key={index} className="flex-1 flex flex-col items-center">
                      <div 
                        ...
                        style={{ 
                          ...
                          opacity: index === 3 ? 1 : 0.6 // Highlight current month
                        }}
                      ></div>
                ...
                <div className="flex justify-between mt-4">
                  ...
                  <div className="text-sm font-medium">{formatCurrency(38750)}</div>
                </div>
              </div>
            </CardContent>
          </Card>
