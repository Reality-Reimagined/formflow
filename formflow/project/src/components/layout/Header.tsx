...
const Header: React.FC<HeaderProps> = ({ title, onMenuClick, user }) => {
  ...
  return (
    <header className="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 lg:px-6">
      ...
      <div className="hidden md:flex items-center border border-gray-300 rounded-md px-3 py-1 bg-gray-50 flex-1 max-w-md mx-4">
        ...
        <input
          ...
          className="bg-transparent border-none outline-none placeholder-gray-500 text-sm flex-1"
        />
      </div>
